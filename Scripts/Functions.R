...
plotTraceExamples <- function(behaviours, data, individuals, n_samples = 200, n_col = 1) {
  #' Plots a trace signalling plot of XYZ accelerometer data.
  #' @param behaviours = A vector of unique behaviours from the data set.
  #' @param data = the dataset being used.
  #' @param individuals = an integer of the number of unique individuals in the dataset
  #' @param n_samples = the sampling rate??? Set to sample_rate by default.
  #' @param n_col = The number of columns drawn in the plot. Set as one by default for an example.
  #' @return = A trace signalling plot.
